	...
	<div class="limiter">
		<div class="container-login100" style="background-image: url('images/bg-02.jpg');">
			<div class="wrap-login100">
				<form action="login.php" class="login100-form validate-form" method="POST" name="myForm" onsubmit="return validateForm()">
					...
					<div class="text-center p-t-5">
						<a style="color:white;" class="txt1" href="newentrepreneur.html">
							New Entrepreneur?
						</a>
					</div>
					<br>
					<div class="text-center p-t-5">
						<a style="color:white;" class="txt1" href="investorlogin.php">
							Login as investor
						</a>
					</div>
