...
<body>
                    ...
                    <div class="row align-items-center no-gutters">
                        ...
                        <div class="col-xl-8 col-lg-8">
                            <div class="main-menu  d-none d-lg-block text-center">
                                <nav>
                                    <ul id="navigation">
                                        <li><a href="#service_area">Researches</a></li>
                ...
                <div class="row align-items-center justify-content-start">
                    <div class="col-lg-10 col-md-10">
                        ...
                        <div class="slider_text">
                            ...
                            <br><br>
                            <a class="boxed-btn3 wow fadeInLeft"  data-wow-duration="1s" data-wow-delay=".2s" href="#service_area">Visit Our Researches</a>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="service_area" id="service_area">
        <div class="container">
            ...
            $sql = "select id,title,description,creator,category,other_category,img_path,path,date from research order by id desc limit 6";
        ...
        echo"</div><br><br><br>";    
        ?>  
         <center><a class="boxed-btn3 wow fadeInLeft"  data-wow-duration="1s" data-wow-delay=".2s" href="allresearches.php">See More Researches</a></center>   
        </div>
    </div>
    <!--/ service_area  -->
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-xl-7 col-lg-7 col-md-9">
                        ...
                        <ul>
                                ...
                                <li><a class="wow fadeInDown" data-wow-duration="1s" data-wow-delay=".4s" href="#features">About</a></li>
